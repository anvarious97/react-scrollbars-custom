...
var ScrollbarThumb = /** @class */function (_super) {
  ...
  function ScrollbarThumb() {
    ...
    _this.handleOnDragStart = function (ev, data) {
      ...
      _this.elementRef.current.classList.add('dragging');
    };
    ...
    _this.handleOnDragStop = function (ev, data) {
      ...
      if (_this.elementRef.current) _this.elementRef.current.classList.remove('dragging');
      if (isBrowser) {
...
var ScrollbarTrack = /** @class */function (_super) {
  __extends(ScrollbarTrack, _super);
  function ScrollbarTrack() {
    var _this = _super !== null && _super.apply(this, arguments) || this;
    _this.elementRef = React.createRef();
    _this.handleClick = function (ev) {
      if (!ev || !_this.elementRef.current || ev.button !== 0) {
        return;
      }
      if (isFun(_this.props.onClick) && ev.target === _this.elementRef.current) {
        if (!isUndef(ev.offsetX)) {
