...
class ScrollbarThumb extends React.Component {
    constructor() {
        ...
        this.handleOnDragStop = (ev, data) => {
            ...
            if (this.elementRef.current)
                this.elementRef.current.classList.remove('dragging');
            if (isBrowser) {
    ...
    render() {
        ...
        return (React.createElement(DraggableCore, { allowAnyClick: false, enableUserSelectHack: false, onMouseDown: this.handleOnMouseDown, onDrag: this.handleOnDrag, onStart: this.handleOnDragStart, onStop: this.handleOnDragStop, nodeRef: this.elementRef }, renderDivWithRenderer(props, mergeRefs([this.elementRef, elementRef]))));
    }
}
...
class ScrollbarTrack extends React.Component {
    ...
    componentWillUnmount() {
        var _a;
        (_a = this.elementRef.current) === null || _a === void 0 ? void 0 : _a.removeEventListener('click', this.handleClick);
    }
    render() {
        const { 
        // eslint-disable-next-line @typescript-eslint/no-unused-vars
